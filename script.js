...
const projects = [
    {
        ...
        subtitle: "IoT Monitoring for Smartphone Assembly",
        description: "Built during an internship at Oppo Indonesia Manufacturing, this project became a real-time monitoring system for screen guard assembly machines.",
        details: `Background: I designed an IoT device to collect temperature, humidity, dust, and connectivity data from a critical screen guard machine line. Goals: The main objective was to reduce unexpected downtime, lower NG rate, and enable fast issue detection through dashboards. Result: The solution fed sensor data into InfluxDB and Grafana, produced real-time alerts, and improved visibility for production operations.`,
        image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=800&q=80"
    },
    {
        title: "Collaborative Robot (COBOT)",
        subtitle: "Gantry Pick & Place System",
        description: "A gantry-style collaborative robot developed to automate pickup of smartphone units between production machines and conveyors.",
        details: `Background: During the Oppo internship, I built a PLC-controlled gantry robot that combined pneumatic actuation with belt-driven rails. Goals: Improve assembly line throughput, reduce human fatigue, and maintain precision handling of small smartphone parts. Result: The robot supported continuous operation, reduced manual work, and helped production maintain higher consistency and speed.`,
        image: "https://images.unsplash.com/photo-1567789884554-0b844b597180?auto=format&fit=crop&w=800&q=80"
    },
    {
        title: "System Robotic Complex for Industrial Smartphone",
        subtitle: "РТК для производства смартфонов",
        description: "A thesis-level robotic system integrating PLC, microcontrollers, and computer vision to automate smartphone transport and inspection.",
        details: `Background: This project was developed as an advanced production solution to move smartphones through assembly lines with dual-lane transport and visual inspection. Goals: Create a smart system that could monitor cycle data, detect defects, and report results in real-time. Result: The complex architecture enabled data collection into Grafana, MQTT-based storage in InfluxDB, and autonomous decision flow for inspection and reporting.`,
        image: "https://images.unsplash.com/photo-1531297484001-80022131f5a1?auto=format&fit=crop&w=800&q=80"
    },
    {
        title: "Adaptive Gripper",
        subtitle: "Computer Vision and ESP32 Integration",
        description: "A two-finger adaptive gripper designed for smartphone quality inspection using vision and IoT control.",
        details: `Background: As part of the robotics complex thesis, I created a gripper made from ABS and 3D-printed parts that adjusts to smartphone geometry. Goals: Enable reliable grasping, integrate CV inspection, and communicate status through Modbus RTU and ESP32 systems. Result: The gripper used ESP32-CAM, classical CV, and FOMO model inference to perform quality checks while handling devices safely and accurately.`,
        image: "https://images.unsplash.com/photo-1578663248512-2ee6f49c45a8?auto=format&fit=crop&w=800&q=80"
    },
    {
        title: "Self Balancing Robot",
        subtitle: "PID + LQR Control System",
        description: "A course project that combined Simulink control design with a custom two-wheel robot prototype built from PLA and 3D-printed components.",
        details: `Background: This project was completed in a control systems course and focused on developing stability algorithms for a self-balancing platform. Goals: Compare PID and LQR controllers, tune the system in simulation, and implement the best approach on hardware. Result: The prototype achieved stable balancing performance with a control architecture validated through both simulation and real tests.`,
    ...
    },
    {
        ...
        subtitle: "Turntable Mechanism Design",
        description: "A mechanical engineering project analyzing the structure and motion of a five-degree-of-freedom robot arm and its turntable assembly.",
        details: `Background: The work focused on technical drawings, gear design, and structural calculations for a 5-DOF manipulator arm. Goals: Model the rotary mechanism, verify torque and inertia, and build a functional prototype with ABS and 3D-printed parts. Result: The project produced a validated manipulator design with detailed spur gear calculations and mechanical documentation.`,
        image: "https://images.unsplash.com/photo-1518709268805-4e9042af2176?auto=format&fit=crop&w=800&q=80"
    },
    {
        title: "Stackster",
        subtitle: "Smart Mobile Robot with IoT",
        description: "A factory mobile robot with a zigzag lifting mechanism, developed for remote control and automatic line-following operation.",
        details: `Background: Created as a course project in mechanisms and machines, Stackster combines kinematic design with IoT control using Blynk. Goals: Enable both automatic line following and manual remote operation, while supporting material handling in a compact factory layout. Result: The robot was demonstrated with MATLAB simulation and real-world control scenarios, delivering a versatile smart mobile solution.`,
        image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
        title: "Automated Wardrobe",
        subtitle: "Hardathon 2025 MVP",
        description: "A competition project that automated wardrobe management for students, earning Favorite Project and 4th place at Hardathon.",
        details: `Background: Developed during Hardathon 2025 at Bauman MSTU, this project aimed to support student daily activities with an automated wardrobe prototype. Goals: Deliver a functional MVP, design the workflow, and build the prototype quickly for competition. Result: The project won 4th place and Favorite Project recognition by combining practical design with a strong team execution.`,
        image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=800&q=80"
    },
    {
        title: "C.L.A.R.A",
        subtitle: "Climate Learning and Response Assistant",
        description: "An IoT system with environmental monitoring, machine learning, and Telegram notification for weather-aware automation.",
        details: `Background: C.L.A.R.A collects temperature, humidity, rain probability, and dry status with an ESP32-based sensor network. Goals: Train ML models in Python, automate alerts through N8N, and present real-time status on a TFT LCD. Result: The system provides weather prediction, device monitoring, and instant Telegram notifications as a complete climate response assistant.`,
...
function renderProjects() {
    ...
    projects.forEach(project => {
        ...
        card.querySelector('.project-btn').addEventListener('click', function(e) {
            e.stopPropagation();
            alert(`More details about "${project.title}"\n\n${project.details}`);
        });
